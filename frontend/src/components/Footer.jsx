      ...
      <footer className="pt-10">
        <div className="max-w-7xl mx-auto px-4 text-gray-600 md:px-8">
          <div className="space-y-6 sm:max-w-md sm:mx-auto sm:text-center">
            <img src="/ex.png" className="w-32 sm:mx-auto" />
            <p>Nulla auctor metus vitae lectus iaculis, vel euismod massa efficitur.</p>
            <div className="items-center gap-x-3 space-y-3 sm:flex sm:justify-center sm:space-y-0">
              <a
                href="javascript:void(0)"
                className="block py-2 px-4 text-center text-black font-medium bg-white duration-150  rounded-lg shadow-lg hover:shadow-none">
                Let's get started
              </a>
              <a
                href="javascript:void(0)"
